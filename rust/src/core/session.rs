...
mod tests {
    ...
    use crate::core::world::{ROOM_WIDTH, RoomId, SpawnResolver};
    ...
    fn death_plan_prefers_checkpoint_reload() {
        let session = RoomSession::new(room(0, 0));
